 ...
 * @param array  $options The options array can contain the following keys:
 *                        - redirect: The URL to redirect to
 *                        - exit: Whether to exit the script
 *
 * @return void
 */
 ...
 */
function getTotalExpensesForCurrentMonth(PDO $conn): float
{
	...
	return $result['total_expenses'] ?? 0.00;
}
